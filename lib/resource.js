...
function _setup(token, service) {
    ...
    // We need to clobber the .next and .getAll on endpoints that don't support it
    if ( !service.optional || _.indexOf(service.optional, "page") == -1 ) {
        this.next = function () { return false; };
        this.getAll = function () { return false; };
    }
}
...
function _request (params, cb, page) {
    ...
    var temp_page = {
                ...
                per_page: (params.per_page) ? params.per_page : resource.pageDefault.per_page
    }
